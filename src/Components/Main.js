  ...
  return (
    <>
      ...
      <div className='main flex  text-[1.10rem] items-center   w-[85%] pt-28' >
        ...
        <div className='profile-img w-[40%] ml-20'>
            <img src={profile}/>
        </div>
      </div>
